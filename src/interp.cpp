...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "dual wield",     do_second,      POS_STANDING,    0,  LOG_NORMAL, 1 },
...
/*  { "unlock",		do_unlock,	POS_RESTING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "detonate",	do_detonate,	POS_STANDING,	 0,  LOG_ALWAYS, 1 },

    /*
     * Clan commands
     */
    { "accept",		do_induct,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "cedit",		do_cedit,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "clan",		do_clantalk,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
    { "clist",		do_clist,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
    { "delclan",	do_delclan,	POS_SLEEPING,	ML,  LOG_NORMAL, 1 },
    { "induct",		do_induct,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "join",		do_join,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "makeclan",	do_makeclan,	POS_STANDING,	 0,  LOG_ALWAYS, 1 },
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "reclass",	do_reclass,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    ...
    { "sla",		do_sla,		POS_DEAD,	IM,  LOG_NORMAL, 0 },
    { "slay",		do_slay,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
    ...
    { "giveskill",	do_giveskill,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
    { "pardon",		do_pardon,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
    { "wanted",		do_wanted,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
     ...
     * Creators (59)
     */
    { "copyove",	do_copyove,	POS_DEAD,	L1,  LOG_NORMAL, 0 },
    ...
    { "laston",		do_laston,	POS_DEAD,	ML,  LOG_NORMAL, 1 },
    { "trust",		do_trust,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
    { "violate",	do_violate,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },

    /*
     * Stuff that had to be at the end (to preserve ability to use)
     */
...
char * return_wizhelp( int level )
{
    ...
    {
        if ( cmd_table[cmd].level >= LEVEL_HERO
        &&   cmd_table[cmd].show && cmd_table[cmd].level == level)
	{
