...
const struct flag_type area_flags[] =
{
    ...
    {	"no_pk",		AREA_NO_PK,		TRUE	},
    {	"all_pk",		AREA_ALL_PK,		TRUE	},
    {	NULL,			0,			0	}
};
...
const	struct	size_type	info_table	[] =
{
	...
	{
		"For a nifty look at the overall progress of "
		"online players, type 'nw'."
	},

	{
		"Type 'clist' for a list of clans. 'clist <name>' "
		"displays more information about a given clan."
	},

	{
		"Remember that almost anything you do will increase "
		"your combat abilities.  High stats, heavy weapons, "
		"and adept skill levels will all go toward making "
		"you unstoppable."
	},
	...
	{
		"There are many shortucts available for typing in "
		"commands.  For example, gossip can be acessed using "
