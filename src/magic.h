...
DECLARE_SPELL_FUN(	spell_redwood_health	);
DECLARE_SPELL_FUN(	spell_aspen_health	);
DECLARE_SPELL_FUN(	spell_pine_health	);
DECLARE_SPELL_FUN(	spell_sapling_health	);
DECLARE_SPELL_FUN(	spell_oaken_strength	);
DECLARE_SPELL_FUN(	spell_call_ent		);
