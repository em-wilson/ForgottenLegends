...
DECLARE_DO_FUN( do_bank_balance );
DECLARE_DO_FUN( do_bank_close   );
DECLARE_DO_FUN( do_bank_deposit );
DECLARE_DO_FUN( do_bank_open    );
DECLARE_DO_FUN( do_bank_withdraw);
...
DECLARE_DO_FUN( do_odump	);
DECLARE_DO_FUN( do_odump2	);
